...
class Top:
    def __init__(self):
        ...
        self.pages = ['https://movie.douban.com/top250?start={}&filter='.format(str(i)) for i in range(0, 250, 25)]
    ...
    def top_page(self, url):
        ...
        pattern = re.compile('<a href="(https://movie.douban.com/subject/.*?)".*?"title">(.*?)</span>', re.S)
